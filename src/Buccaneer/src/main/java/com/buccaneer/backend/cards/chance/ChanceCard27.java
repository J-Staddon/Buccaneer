...
public class ChanceCard27 extends ChanceCardBase {

    public ChanceCard27() {
        super.name = "Take treasure up to 5 in total value, or 3 crew cards from Pirate Island.";
        super.description = "";
    }
    ...
    public boolean execute(MapSquare[][] mapGrid, Ship ship, ArrayList<CrewCard> crewCards, ArrayList<Island> islands, ArrayList<ChanceCardBase> chanceCardDeck) {
        super.takeTreasureOrCard(mapGrid, ship, crewCards, 3, 5);
        return false;
    }
