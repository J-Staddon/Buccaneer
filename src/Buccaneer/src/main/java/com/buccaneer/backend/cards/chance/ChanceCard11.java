...
public class ChanceCard11 extends ChanceCardBase {

    public ChanceCard11() {
        super.name = "Take treasure up to 5 in total value, or 2 crew cards from Pirate Island.";
        super.description = "";
    }
    ...
    public boolean execute(MapSquare[][] mapGrid, Ship ship, ArrayList<CrewCard> crewCards, ArrayList<Island> islands, ArrayList<ChanceCardBase> chanceCardDeck) {
        super.takeTreasureOrCard(mapGrid, ship, crewCards, 2, 5);
        return false;
    }
